...
public class TravelDate extends BasePage {
	...
	public void setTravelDate(String dday, String dmonth, String dyear, String rday, String rmonth, String ryear,
			ExtentTest log) {
		departureDate(dday,dmonth,dyear,log);
		returnDate(rday,rmonth,ryear,log);
	}
	...
	public void returnDate(String day, String month, String year,ExtentTest log) {
